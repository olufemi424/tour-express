...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2x1ZmVtaWFmIiwiYSI6ImNrNzg5czkxajBnZjEzbG9nbzdrdjJlenYifQ.RYnnJ62Zp8I3quSunYt-5g';
...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); //remove alert
...
var userDataForm = document.querySelector('.form--data');
var userDataBtn = document.querySelector('.form--data .btn');
var userPasswordForm = document.querySelector('.form-user-password');
var userPasswordBtn = document.querySelector('.btn--save-password');
